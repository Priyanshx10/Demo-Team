...
const Livarae = () => {
  return (
    <section className='flex-col items-center text-center'>
      <h1 className="font-myriad text-[70px] font-bold leading-[84px] tracking-[0.06em] text-[#47174C]">
        Livrare și achitare
      </h1>
      <p className="font-inter text-[22px] font-medium leading-[26.63px] tracking-[0.06em] text-[#47174C]">
        Suntem orientați spre comoditatea clienților noștri, de aceea <br />
        oferim opțiuni flexibile de achitare și primire a produsului nostru.
      </p>

      <div className="flex flex-1 justify-center pt-40 px-20 space-x-2">
